...
Assigns disease status to all individuals in .mut (.spl) file based on betas
from .beta file
"""
        ...
        with open(self.spl, 'r') as infile, self.output().open('w') as outfile:
            for i, line in enumerate(infile):
                ...
                if affect == 1 and cases == self.casen and ctrls != self.ctrln:
                    ...
                    break
                #print self.casen, self.ctrln, cases, ctrls
                ...
                #    print betas[43] 
                #    print gts[43]
                #print indiv1, X_beta, hom_ref, het, hom_alt
                if affect == 1:
                    cases += 1
                else:
                    ctrls += 1
                outfile.write('{}\t{}\t{}\t{}\n'.format(indiv1, X_beta, prob, affect))
